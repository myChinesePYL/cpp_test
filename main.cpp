...
#include "include/ftxui/dom/elements.hpp"  // for canvas, Element, separator, hbox, operator|, border
#include "include/ftxui/screen/screen.hpp"  // for Pixel
#include <memory>   // for allocator, shared_ptr, __shared_ptr_access
#include <string>   // for string, basic_string
#include <utility>  // for move
#include <vector>   // for vector, __alloc_traits<>::value_type

#include "include/ftxui/component/component.hpp"  // for Renderer, CatchEvent, Horizontal, Menu, Tab
#include "include/ftxui/component/component_base.hpp"      // for ComponentBase
#include "include/ftxui/component/event.hpp"               // for Event
#include "include/ftxui/component/mouse.hpp"               // for Mouse
#include "include/ftxui/component/screen_interactive.hpp"  // for ScreenInteractive
#include "include/ftxui/dom/canvas.hpp"                    // for Canvas
#include "include/ftxui/screen/color.hpp"  // for Color, Color::Red, Color::Blue, Color::Green, ftxui
